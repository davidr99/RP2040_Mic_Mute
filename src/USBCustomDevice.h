...
#ifndef USBCUSTOMDEVICE_H
#define USBCUSTOMDEVICE_H
...
public:
    ...
    */
    USBCustomDevice(bool connect_blocking = true, uint16_t vendor_id = 0x1235, uint16_t product_id = 0x0050, uint16_t product_release = 0x0001);
    ...
    * @param product_release Your product_release
    */
    USBCustomDevice(USBPhy *phy, uint16_t vendor_id = 0x1235, uint16_t product_id = 0x0050, uint16_t product_release = 0x0001);
